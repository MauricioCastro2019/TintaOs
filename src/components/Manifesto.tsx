    ...
    <section style={{ position: 'relative', padding: '4rem 0', background: 'var(--bg-secondary)', overflow: 'hidden' }}>
      ...
      <div className="container-narrow">
        <div className="reveal" ref={ref1} style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 'clamp(1.3rem, 3.5vw, 2.1rem)', letterSpacing: '-0.025em', lineHeight: 1.2, color: 'var(--text-primary)', maxWidth: '600px', margin: '0 auto' }}>
