    ...
    <section style={{ position: 'relative', padding: '4rem 0', background: 'var(--bg-secondary)', overflow: 'hidden' }}>
      ...
      <div className="container-narrow">
        <div className="reveal" ref={ref1} style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontWeight: 400, fontSize: 'clamp(1.3rem, 3.5vw, 2.1rem)', letterSpacing: '0.04em', lineHeight: 1.2, color: 'var(--text-primary)', maxWidth: '600px', margin: '0 auto' }}>
            No queremos domesticar el arte.{' '}
            <em style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', color: 'var(--accent-copper-light)', display: 'block', marginTop: '0.2rem' }}>
              Queremos quitarle ruido para que llegue mÃ¡s lejos.
            </em>
          </h2>
        </div>
        ...
        <div className="reveal reveal-delay-1" ref={ref2} style={{ textAlign: 'center' }}>
          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', color: 'var(--text-secondary)', lineHeight: 1.75, marginBottom: '1.5rem', fontStyle: 'italic', fontWeight: 300 }}>
            Creemos en el tatuador que aprendiÃ³ viendo, practicando y mejorando a pulso. En quien convierte una idea ajena en una pieza que alguien llevarÃ¡ toda la vida. En quien empieza con pocos recursos, pero con hambre de construir algo grande.
          </p>
          ...
          <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.75, marginBottom: '1.25rem' }}>
            La tecnologÃ­a no deberÃ­a volver frÃ­o este oficio. DeberÃ­a darle estructura sin quitarle alma.
          </p>

          <p style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', fontSize: '1.1rem', color: 'var(--accent-copper-light)' }}>
            BlackVein se estÃ¡ construyendo desde esa idea.
          </p>
        </div>
      </div>
    </section>
